...
immunegeneFunction <- read.table("/Users/normacy/Desktop/2018immuneGene/01data/InnateImmuneGeneFunction",header=T,sep="\t")

#innate_genes
immunegene <- immunegene[intersect(rownames(immunegene),immunegeneFunction[immunegeneFunction$Catalog=="Innate immune response",]$ensembl),]
