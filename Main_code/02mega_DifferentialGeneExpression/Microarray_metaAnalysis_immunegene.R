...
write.csv(file="./results/tables/Microarray_AD_immunegene_metaanalysis_123018.csv",AD_meta)
...
write.csv(file="./results/tables//Microarray_ASD_immuneGENE_metaanalysis_123018.csv",asd_meta)
...
write.csv(file="./results/tables/Microarray_SCZ_ImmuneGenemetaanalysis_123018.csv",scz_meta)
...
write.csv(file="./results/tables/Microarray_BD_immunegene_metaanalysis_123018.csv",bd_meta)
...
write.csv(file="./results/tables/Microarray_MDD_immunegene_metaanalysis_123018.csv",mdd_meta)
...
for(i in 1:nrow(PD_datExpr)) {
  ...
  tryCatch({
    PD_meta[i,] = summary(lme(expr~ Group + Study,data = PD_datMeta, random=~1|Subject))$tTable[2,c(1,2,5)]
  }, error=function(e){})
}
...
write.csv(file="./results/tables/Microarray_PD_immunegene_metaanalysis_092017.csv",PD_meta)
...
write.csv(file="./results/tables/Microarray_IBD_immunegene_metaanalysis_123018.csv",ibd_meta)
